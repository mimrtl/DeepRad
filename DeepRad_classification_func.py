...
from DeepRad_classification import Ui_MainWindow
from configuration import Config_Classification
...
class mainwindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def getCurrentPrepareDataConfigFromGUI(self):
        self.config_classification.config['data_folder'] = self.lineEdit_8.text()
